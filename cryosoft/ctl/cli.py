"""The command grammar of ``python -m cryosoft.ctl``.
...
::
    ...
    python -m cryosoft.ctl [connection options] <subcommand> [arguments]
...
from cryosoft.ctl.client import (
...
from cryosoft.troubleshoot.cli import resolve_config
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m cryosoft.ctl",
        description=(
            "CryoSoft reference client: drive the instrument through the agent "
