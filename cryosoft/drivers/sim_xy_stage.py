...
class SimXYStage:
    ...
    * ``stop()`` halts an axis where it is and pins its target there.
    ...
    3. It is importable via cryosoft.drivers.sim_xy_stage.
    """
    ...
    def move_to(self, x_m: float | None = None, y_m: float | None = None) -> None:
        ...
        Raises:
            CryoSoftInstrumentError: ``TRAVEL_LIMIT`` if a target lies
    ...
    def set_speed(self, speed_m_per_s: float) -> None:
        ...
        Raises:
            CryoSoftInstrumentError: ``SPEED_RANGE`` if the value is outside
    ...
    def get_idn(self) -> str:
        ...
        self._check_error()
        return "CRYOSOFT,SIMXYSTAGE,SIM,1.0"
