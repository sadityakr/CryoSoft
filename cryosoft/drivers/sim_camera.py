...
class SimCamera:
    ...
    3. It is importable via cryosoft.drivers.sim_camera.
    """
    ...
    def set_exposure_s(self, exposure_s: float) -> None:
        ...
        Raises:
            CryoSoftInstrumentError: ``EXPOSURE_RANGE`` if the value is
    ...
    def set_binning(self, binning: int) -> None:
        ...
        Raises:
            CryoSoftInstrumentError: ``BINNING_UNSUPPORTED`` for any other
                factor.
        """
        self._check_error()
    ...
    def set_roi(self, x0: int, y0: int, width: int, height: int) -> None:
        ...
        Raises:
            CryoSoftInstrumentError: ``ROI_RANGE`` if the rectangle does not
                fit the sensor.
        """
        self._check_error()
    ...
    def get_frame(self) -> np.ndarray:
        ...
        Raises:
            CryoSoftInstrumentError: ``NOT_ARMED`` if ``arm()`` has not been
                called.
        """
        self._check_error()
        if not self._armed:
    ...
    def get_idn(self) -> str:
        ...
        self._check_error()
        return "CRYOSOFT,SIMCAMERA,SIM,1.0"
