...
- An `Orchestrator` instance. Signals the GUI connects to: `states_updated`,
  ...
  and `operational_status` (consumed live by `DiagnosticsWindow`). Run-scoped
