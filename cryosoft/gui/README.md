...
- An `Orchestrator` instance. Signals the GUI connects to: `states_updated`,
  ...
  live by `DebugWindow`; `status_message` is used by `ProcedureWindow`'s
