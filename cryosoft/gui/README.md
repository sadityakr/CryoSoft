...
Session (`cryosoft.session.maintenance_log`/`models`/`manager` — contract
...
(Logs)** holds the relocated `LogPanel` and nothing else. Page 1's bottom-right quadrant is a VERTICAL splitter
