...
The recipe catalogue is read through ``cryosoft.analysis.discovery``, imported
...
from cryosoft.gui.eln_settings_dialog import persist_eln_settings
...
class AnalysisPanel(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        #: Whether ``cryosoft.analysis.discovery`` could be imported at all.
    ...
    def _discover_recipes(self) -> tuple[Any, ...]:
        ...
        """
        try:
            from cryosoft.analysis.discovery import discover_recipes
        except ImportError:
    ...
    def _reload_recipes(self) -> None:
        ...
        chosen = ""
        try:
            from cryosoft.analysis.discovery import recipe_for
        except ImportError:
            pass
        else:
            try:
    ...
    def _on_new_recipe_clicked(self) -> None:
        ...
        if not accepted or not name.strip():
            return
        try:
            from cryosoft.analysis.discovery import scaffold_recipe
        except ImportError:
