...
from cryosoft.core.events import event_from_json
...
INSTRUCTIONS = (
    "This server drives a running CryoSoft cryostat. Every tool is the "
    ...
    "retrying. Read cryosoft://status and cryosoft://station before acting, "
    "and validate or probe a run before starting one."
)

#: The three resources: the live snapshot, the station's declaration, and
#: the capability manifest.
STATUS_URI = "cryosoft://status"
STATION_URI = "cryosoft://station"
MANIFEST_URI = "cryosoft://manifest"
...
def log_notification(notification: Mapping[str, Any]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "params": {"level": level, "logger": "cryosoft.gateway", "data": data},
    }
